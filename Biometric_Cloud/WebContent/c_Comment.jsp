...
<div class="main">
  ...
  <div align="center" class="style1">  
    ...
    <table width="465" border="0">
      <tr>
        <td width="245" bgcolor="#FF0000"><div align="center" class="style13 style11 style8"><strong> ID </strong></div></td>
        <td width="210"><label>
          <input type="text" name="t" value="<%=i%>" readonly>
        </label></td>
      </tr>
      <tr>
        <td bgcolor="#FF0000"><div align="center" class="style13 style11 style8"><strong>Biometric Image Title </strong></div></td>
        <td><label>
          <input type="text" name="t1" value="<%=s2%>" readonly>
        </label></td>
      </tr>
     <tr>
        <td bgcolor="#FF0000"><div align="center" class="style13 style11 style8"><strong>Biometric Image Name </strong></div></td>
        <td><label>
          <input type="text" name="t2" value="<%=s3%>" readonly>
        </label></td>
      </tr>
      <tr>
        <td bgcolor="#FF0000"><div align="center" class="style13 style11 style8"><strong>Comment</strong></div></td>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style14">
			<li><a href="consumerMain.jsp">Users  Main</a></li>
