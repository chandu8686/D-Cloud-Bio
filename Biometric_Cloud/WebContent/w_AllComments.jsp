...
%>
 ...
 <table width="510" border="1" align="center"  cellpadding="0" cellspacing="0"  >
   ...
   <tr>
     <td  width="184" height="45" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10 style5 style16" style="margin-left:20px;"><strong> ID </strong></div></td>
     <td width="142" bgcolor="#FF0000"><span class="style15 style10 style6 style7"> &nbsp;&nbsp;<%=id%></span></td>
   </tr>
   <tr>
     <td  width="184" height="48" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10 style5 style16" style="margin-left:20px;"><strong>Image Title </strong></div></td>
     <td bgcolor="#FF0000"><span class="style15 style10 style6 style7">&nbsp;&nbsp;<%=encryptedTitle%></span></td>
   </tr>
   <tr>
     <td  width="184" height="39" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10 style5 style16" style="margin-left:20px;"><strong>Image Name </strong></div></td>
     <td bgcolor="#FF0000"><span class="style15 style10 style6 style7">&nbsp;&nbsp;<%=encryptedName%></span></td>
   </tr>
   <tr>
     <td  width="184" height="25" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style10 style5 style16" style="margin-left:20px;"><strong>Rank</strong></div></td>
    ...
    <tr>
      <td  width="144" height="30" colspan="1" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style10 style5 style17"><strong>Commented By</strong></div></td>
      <td  width="144" height="30" colspan="1" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style10 style5 style17"><strong>Comments Details </strong></div></td>
      <td  width="144" height="30" colspan="1" valign="middle" bgcolor="#FF0000" style="color: #9e4c66;"><div align="left" class="style16 style10 style5 style11" style="margin-left:20px;">
